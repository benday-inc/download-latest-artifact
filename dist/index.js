...
function getLatestRunForWorkflow(client, forWorkflow, branchName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield temp;
        if (!response || response === null || response.data === null) {
            core.setFailed('Call to get workflow runs failed with undefined or null result');
            return null;
        }
        else if (response.data.total_count === 0) {
